    ...
    public partial class MainForm : Form
    {
        public MainForm()
        {
            ...
            try
            {
                ...
                {
                    consoleInputOutput.Write(eve.Line, eve.IsLine);
                };
        ...
        private RichTextBox SelectedRichTextBox
        {
            get
            {
                return (RichTextBox)SelectedPage.Controls[Properties.Resources.RichTextBoxControl];
            }
        }
        ...
        private string[] CurrentText
        {
            get
            {
                return SelectedRichTextBox.Lines;
            }
            set
            {
                SelectedRichTextBox.Lines = value;
            }
        }
        ...
        {
            RichTextBox ri = new RichTextBox() { Dock = DockStyle.Fill, Name = Properties.Resources.RichTextBoxControl, Font = programSettings.TextFont };
            ri.TextChanged += (o, e) => StatuBar = "Ready";
            TabPage page = new TabPage(new DirectoryInfo(fileName).Name) { Tag = fileName };
        ...
        {
            InitializeTabPageForFile(fileName, true);
        }
        ...
        {
            return MessageBox.Show("Do you want to save changes to the files?", "Save",
        ...
        private void optionsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (options == null)
            {
                ...
                options.ReloadFiles = programSettings.ReloadFiles;
                options.newFont = programSettings.TextFont;
                options.AutoSave = programSettings.AutoSave;
            }
